...
rootFolder = IsString(Replace(WScript.ScriptFullName,WScript.ScriptName,""))		
...
'sTag =
'wscript.echo Replace(Replace(WScript.ScriptName,"Install_Fusion ",""),".vbs","")
SetupVersion = Split(WScript.ScriptName," ")(1)
sTag = Replace(Split(WScript.ScriptName," ")(2),".vbs","")

SetupOptions = "/quiet NO_SSL_CHECK=1 RUNNOW=1 SERVER='https://support.jbcao.fr/front/inventory.php' TAG=" & sTag
'SetupOptions = "/quiet NO_SSL_CHECK=1 RUNNOW=1 SERVER='https://support.jbcao.fr/' TAG=" & sTag
if (instr(1,Ucase(sTag),"TEST",1) > 0 ) Then
	wscript.echo "SetupVersion = " & SetupVersion & vbCrlf & SetupOptions
	'wscript.sleep 2000
	wscript.Quit
End If  	   
